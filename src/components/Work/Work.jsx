  ...
  const [projects, setProjects] = useState([
    {
      ...
      techstack: 'Technologies used: HTML, CSS, JS. React, Node, MongoDB, Express,  Semantic UI',
    ...
    },
    {
      ...
      techstack: 'Technologies used: HTML, CSS, JS, Python, Django, PostgreSQL, AWS, Google Maps API, Materialize',
    ...
    },
    {
      ...
      techstack: 'Technologies used: HTML, CSS, JS, MongoDB, Express, Node, EJS,  Materialize, Google OAuth',
